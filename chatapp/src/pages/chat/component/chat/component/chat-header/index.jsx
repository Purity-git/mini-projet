...
const ChatHeader = () => {
    ...
    console.log("First Name:", selectedChatData?.firstName);
    console.log("Email:", selectedChatData?.email);

  return (
    <div className="h-[10vh] border-b-2 border-[#2f303b] flex items-center justify-between px-20 bg-[#1c1d25]">
